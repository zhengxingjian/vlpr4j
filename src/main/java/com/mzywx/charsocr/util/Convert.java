package com.mzywx.charsocr.util;
...
/**
 * There are 3 kinds of convert functions: 1. [float|double|int|long]
 * to[Float|Double|Int|Long](BytePointer pointer) 2. byte[]
 * getBytes([float|double|int|long] value) 3. [float|double|int|long]
 * to[Float|Double|Int|Long](byte[] value)
 * 
 * @author eguid
 * 
 */
