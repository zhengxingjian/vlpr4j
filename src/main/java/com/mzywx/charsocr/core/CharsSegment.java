...
import static com.mzywx.charsocr.core.CoreFunc.getPlateType;
...
public class CharsSegment {
	...
	private Mat preprocessChar(Mat in) {
		...
		warpAffine(in, warpImage, transformMat, warpImage.size(), INTER_LINEAR, opencv_core.BORDER_CONSTANT,
				new Scalar(0));
