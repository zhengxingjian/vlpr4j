package com.mzywx.charsocr.core;

import static com.mzywx.charsocr.core.CoreFunc.features;
...
import com.mzywx.charsocr.util.Convert;
...
//	 private CvANN_MLP ann = new CvANN_MLP();
	...
	private final String strChinese[] = { "zh_cuan" /* 川 */, "zh_e" /* 鄂 */, "zh_gan" /* 赣 */, "zh_gan1"/* 甘 */,
			...
			"zh_jing" /* 京 */, "zh_jl" /* 吉 */, "zh_liao" /* 辽 */, "zh_lu" /* 鲁 */, "zh_meng" /* 蒙 */, "zh_min" /* 闽 */,
			"zh_ning" /* 宁 */, "zh_qing" /* 青 */, "zh_qiong" /* 琼 */, "zh_shan" /* 陕 */, "zh_su" /* 苏 */,
			"zh_sx" /* 晋 */, "zh_wan" /* 皖 */, "zh_xiang" /* 湘 */, "zh_xin" /* 新 */, "zh_yu" /* 豫 */, "zh_yu1" /* 渝 */,
